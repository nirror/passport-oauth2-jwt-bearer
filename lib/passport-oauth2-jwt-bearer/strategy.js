...
Strategy.prototype.authenticate = function(req) {
  ...
  var self = this,
      ...
      assertion_type  = req.body['client_assertion_type'],
      assertion = req.body['client_assertion'];

  if(grant_type === 'urn:ietf:params:oauth:grant-type:jwt-bearer') {
    assertion = req.body['assertion'];
  } else if(grant_type === 'authorization_code' && assertion_type === 'urn:ietf:params:oauth:client-assertion-type:jwt-bearer') {
    assertion = req.body['client_assertion'];
  } else {
    return this.fail();
  }

  if(!assertion) return this.fail();
